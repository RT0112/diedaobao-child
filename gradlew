...
# Collect all arguments for the java command, stracks://am the current directory to the first
# if $@ contains at least one argument, pass all arguments; otherwise, pass the current directory
if [ "$#" -gt 0 ] ; then
